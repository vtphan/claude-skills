...
The canonical schema is `references/fbra-schema.md`. The canonical commit contract is `references/commit-message-contract.md`. Each skill also has mirrored copies so it can load its local references directly.
