...
For small or low-risk projects, the human lead may explicitly stop after any round. The agent should not manufacture extra rounds just to satisfy ceremony. Before promotion, still verify that the canonical artifact satisfies its schema, and state which convergence safeguards were skipped, such as no critique round or no two-small-diff sequence.
